...
| [0006](0006-background-execution.md) | PostgreSQL-backed job queue and worker | superseded by 0026 | Background scan execution |
...
| [0014](0014-frontend-stack.md) | React + TypeScript + Vite, generated API client | superseded by 0027 | Frontend framework |
...
| [0017](0017-testing-strategy.md) | Recorded fixtures, no live cloud in CI | superseded in part by 0027 | Testing |
